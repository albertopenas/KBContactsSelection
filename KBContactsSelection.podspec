Pod::Spec.new do |s|
  ...
  s.screenshots  = "https://raw.githubusercontent.com/burczyk/KBContactsSelection/master/assets/KBContactsSelection.png", "https://raw.githubusercontent.com/burczyk/KBContactsSelection/master/assets/KBContactsSelection.gif"
  ...
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/burczyk/KBContactsSelection.git", :tag => "1.0.0" }

  s.source_files  = "KBContactsSelection", "KBContactsSelection/**/*.{h,m}"
  s.resources = "KBContactsSelection/*.xib"
  s.framework  = "MessageUI"
  s.requires_arc = true
  s.dependency "APAddressBook", "0.1.14"
